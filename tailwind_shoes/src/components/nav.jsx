...
export function Navbar({ onClickShoppingBtn }) {
  ...
  return (
    <nav className="flex flex-wrap justify-between z-10 relative">
      ...
      <button
        ...
        className="dark:text-gray-400 dark:hover:bg-gray-700 lg:hidden focus:ring-2 focus:ring-gray-200 rounded-lg hover:bg-gray-100"
      >
      ...
      >
        <ul className="lg:space-x-8 lg:dark:text-white bg-gray-50 lg:bg-transparent flex flex-col lg:flex-row text-lg border border-gray-100 lg: border-none rounded-lg p-4">
          {MENUS.map((menu, i) => {
            return (
              <li
      ...
      <div
        ...
        className="fixed left-8 py-2 px-3 bottom-8 lg:static lg:mr-4"
      >
