...
export function ShoeDetail({ shoe, onClickAdd }) {
  ...
  return (
    <div className="flex flex-col lg:flex-row-reverse dark:text-white space-y-4">
      {/*  Shoe Image */}
      <div className="flex-1 lg:-mt-32 lg:ml-28">
        <div className="flex-center h-full bg-gradient-to-br from-[#F637CF] from-5% via-[#E3D876] via-40% to-[#4DD4C6]">
          <img src={shoe.src} alt="shoe image" className="animate-float" />
        </div>
      </div>
      ...
      <div className="flex-1 space-y-6">
        ...
        <div className="space-x-10">
          <button
            ...
            className="btn-press-anim dark:bg-white dark:text-black h-14 w-44 bg-black text-white hover:bg-gray-900 active:bg-gray-700"
          >
            Add to bag
          </button>
